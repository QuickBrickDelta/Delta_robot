...
def GetAngleMoteur1(x_eff, y_eff, z_eff):
    # Fonction qui trouve l'angle de M1 en fonction de la position de l'effecteur
    a1 = -(y_eff + e - f)
    b1 = z_eff
...
def GetGeometrieRobot(x_eff, y_eff, z_eff):
    # Fonction qui détermine la géométrie du robot en fonction de la position de l'effecteur
